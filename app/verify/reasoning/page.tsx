...
const presets = [
  { label: '数学', prompt: '123 × 456 を暗算で計算してください。途中の計算過程も示してください。' },
  { label: '論理パズル', prompt: 'AはBより背が高く、CはBより背が低い。DはAより背が高い。EはCより背が高いがBより背が低い。全員を背の高い順に並べてください。' },
  { label: 'コード生成', prompt: 'TypeScriptで、与えられた配列から重複を除去しつつ元の順序を保持する関数を書いてください。ジェネリクスを使い、時間計算量も説明してください。' },
  { label: '因果推論', prompt: '「道路が濡れている」という観察から考えられる原因を挙げ、それぞれの可能性を論理的に評価してください。' },
];
